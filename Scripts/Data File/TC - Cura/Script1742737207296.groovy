...
WebUI.callTestCase(findTestCase('Data File/TC - Login - Copy'), [('Username') : Username, ('Password') : Password], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Cura/Page_CURA Healthcare Service/Page_CURA Healthcare Service/select_healthcare'))
