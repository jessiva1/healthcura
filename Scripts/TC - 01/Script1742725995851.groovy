...
options.addArguments("--disable-blink-features=BiDiIgnoreCertificateErrors")

// Ubah driver dengan opsi yang telah dimodifikasi
...
GlobalVariable.comment = CustomKeywords.'keywordTesting.StringHelper.generateRandomComment'()

WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), GlobalVariable.comment)
